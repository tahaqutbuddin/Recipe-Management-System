    ...
    }else
    {
        for($i = 0; $i < count($utils_arr);$i++)
        {
            ...
            <div class="chip">
                ...
                <img class="closebtn" onclick="tagCloseFunc(this)" src="form_assets/img/Vector.png" />
            </div>
            ';
        } 
    }
                ...
                <div class="row d-flex flex-column row-border">
                    <div class="col-md-6 col-sm-12">
                        <section class="section-1">
                            ...
                            <input type="hidden" name="cooking_step_id[]" value="0" />
                        ...
                        <div class="row upload-button justify-content-center">
                            <div class="col-xs-6 col-sm-10 col-md-8 d-flex flex-row">
                                <label for="files0" class="btn btn-primary d-flex flex-row uploadbutton-input" >Upload Bild</label>
                                <input id="files0" type="file" hidden>
                            </div>
                        </div>
                    </div>
