                                ...
                                <div class="container" id="slider-custom">
                                    <div class="d-flex flex-column justify-content-start slider col-md-12">
                                        <div class="row text-secondary">
                                            <div class="col-md-4">
                                                <label class="col-form-label" id="field-label-1"><br>Schwierigkeitsgrad (1 =leicht bis 5) <br><br></label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column justify-content-start slider col-md-12">
                                        <div class="row text-secondary">
                                            <div class="col-md-4">
                                                <label class="col-form-label" id="field-label-1"><br>Schärfegrad (0=kein bis 5)<br><br></label>
                                            </div>
                                        </div>
                                        <div class="row button-group">
                                            <div class="col-md-6 col-sm-12">
